...
public class Futbol {
    ...
    public void verEquipoMaxGolesPorXornada(String []equipos, int[] xornadas, int[][] goles){
        int xornadaBuscar = Integer.parseInt(JOptionPane.showInputDialog("Teclee a xornada a buscar que equipo marcou máis goles"));
    }
    ...
    public void verEquipoXornadaPorGoles(String[] equipos, int[] xornadas, int[][] goles){
        int atopado = 0;
        int numGoles = Integer.parseInt(JOptionPane.showInputDialog("Teclee el nº goles a buscar"));
